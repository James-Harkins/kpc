...
@night_1_trip_5 = @trip_5.nights.create!(date: Date.parse('2025-04-26'), cost: 120)
@night_2_trip_5 = @trip_5.nights.create!(date: Date.parse('2025-04-27'), cost: 120)
@night_3_trip_5 = @trip_5.nights.create!(date: Date.parse('2025-04-28'), cost: 120)
@night_4_trip_5 = @trip_5.nights.create!(date: Date.parse('2025-04-29'), cost: 120)
@night_5_trip_5 = @trip_5.nights.create!(date: Date.parse('2025-04-30'), cost: 120)
@night_6_trip_5 = @trip_5.nights.create!(date: Date.parse('2025-05-01'), cost: 120)
@night_7_trip_5 = @trip_5.nights.create!(date: Date.parse('2025-05-02'), cost: 120)

@trip_5_course_1 = @trip_5.rounds.create!(date: Date.parse('2025-04-27'), cost: 0)
@trip_5_course_2 = @trip_5.rounds.create!(date: Date.parse('2025-04-28'), cost: 0)
@trip_5_course_3 = @trip_5.rounds.create!(date: Date.parse('2025-04-29'), cost: 75)
@trip_5_course_4 = @trip_5.rounds.create!(date: Date.parse('2025-04-30'), cost: 75)
@trip_5_course_5 = @trip_5.rounds.create!(date: Date.parse('2025-05-01'), cost: 75)
@trip_5_course_6 = @trip_5.rounds.create!(date: Date.parse('2025-05-02'), cost: 75)