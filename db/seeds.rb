...
@night_1_trip_4 = @trip_4.nights.create!(date: Date.parse('2016-04-24'), cost: 70)
@night_2_trip_4 = @trip_4.nights.create!(date: Date.parse('2016-04-25'), cost: 100)
...
@night_1_trip_5 = @trip_5.nights.create!(date: Date.parse('2024-05-04'), cost: 70)
@night_2_trip_5 = @trip_5.nights.create!(date: Date.parse('2024-05-05'), cost: 80)
@night_3_trip_5 = @trip_5.nights.create!(date: Date.parse('2024-05-06'), cost: 90)
@night_4_trip_5 = @trip_5.nights.create!(date: Date.parse('2024-05-07'), cost: 100)
@night_5_trip_5 = @trip_5.nights.create!(date: Date.parse('2024-05-08'), cost: 70)
@night_6_trip_5 = @trip_5.nights.create!(date: Date.parse('2024-05-09'), cost: 80)
@night_7_trip_5 = @trip_5.nights.create!(date: Date.parse('2024-05-10'), cost: 90)

@trip_5_course_1 = @trip_5.rounds.create!(date: Date.parse('2024-05-05'), cost: 65)
@trip_5_course_2 = @trip_5.rounds.create!(date: Date.parse('2024-05-06'), cost: 55)
@trip_5_course_3 = @trip_5.rounds.create!(date: Date.parse('2024-05-07'), cost: 60)
@trip_5_course_4 = @trip_5.rounds.create!(date: Date.parse('2024-05-08'), cost: 60)
@trip_5_course_5 = @trip_5.rounds.create!(date: Date.parse('2024-05-09'), cost: 65)
@trip_5_course_6 = @trip_5.rounds.create!(date: Date.parse('2024-05-10'), cost: 75)