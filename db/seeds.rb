@golfer_1 = Golfer.create!(first_name: 'James', last_name: 'Harkins', nickname: 'Jim Henry', email: 'jh.harkins@protonmail.com', password: 'tobysLungExp4n5ion', password_confirmation: 'tobysLungExp4n5ion', role: 1)
@golfer_2 = Golfer.create!(first_name: 'Tom', last_name: 'Sardo', nickname: 'Tommy Torts', email: 'Tsardo13@gmail.com', password: '17224Magic!', password_confirmation: '17224Magic!', role: 1)
@golfer_3 = Golfer.create!(first_name: 'JP', last_name: 'Copeland', nickname: 'Peej', email: 'jp.copeland@outlook.com', password: 'FartParty123!', password_confirmation: 'FartParty123!', role: 1)
@golfer_4 = Golfer.create!(first_name: 'Joe', last_name: 'Copeland', nickname: 'JoCo', email: 'joe.cbg.jc@gmail.com', password: 'Eaglekpc2025', password_confirmation: 'Eaglekpc2025', role: 1)
...
@night_1_trip_5 = @trip_5.nights.create!(date: Date.parse('2024-04-26'), cost: 120)
@night_2_trip_5 = @trip_5.nights.create!(date: Date.parse('2024-04-27'), cost: 120)
@night_3_trip_5 = @trip_5.nights.create!(date: Date.parse('2024-04-28'), cost: 120)
@night_4_trip_5 = @trip_5.nights.create!(date: Date.parse('2024-04-29'), cost: 120)
@night_5_trip_5 = @trip_5.nights.create!(date: Date.parse('2024-04-30'), cost: 120)
@night_6_trip_5 = @trip_5.nights.create!(date: Date.parse('2024-05-01'), cost: 120)
@night_7_trip_5 = @trip_5.nights.create!(date: Date.parse('2024-05-02'), cost: 120)

@trip_5_course_1 = @trip_5.rounds.create!(date: Date.parse('2024-04-27'), cost: 0)
@trip_5_course_2 = @trip_5.rounds.create!(date: Date.parse('2024-04-28'), cost: 0)
@trip_5_course_3 = @trip_5.rounds.create!(date: Date.parse('2024-04-29'), cost: 75)
@trip_5_course_4 = @trip_5.rounds.create!(date: Date.parse('2024-04-30'), cost: 75)
@trip_5_course_5 = @trip_5.rounds.create!(date: Date.parse('2024-05-01'), cost: 75)
@trip_5_course_6 = @trip_5.rounds.create!(date: Date.parse('2024-05-02'), cost: 75)